...
const bankSoal = {
  DTS: [
    ...
    //UK2
    {tipe:"DTS", uk:"UK2", soal:1, text:"2.1 Apakah Operator melaporkan KTA dan/atau TTA kepada Pengawas?"},
    {tipe:"DTS", uk:"UK2", soal:2, text:"2.2 Apakah Operator mengetahui metode pelaporan insiden?"},
    {tipe:"DTS", uk:"UK2", soal:3, text:"2.3 Apakah Operator dapat melakukan pelaporan KTA dan/atau TTA dengan aplikasi Sinergi?"},
    {tipe:"DTS", uk:"UK2", soal:4, text:"2.4 Apakah Operator melaporkan malfungsi kondisi unit kepada Pengawas/OCR?"},
    {tipe:"DTS", uk:"UK2", soal:5, text:"2.5 Apakah Operator memahami dan malakukan aturan lampu sein?"},
    {tipe:"DTS", uk:"UK2", soal:6, text:"2.6 Apakah Operator menggunakan radio komunikasi dengan baik dan benar?"},
    {tipe:"DTS", uk:"UK2", soal:7, text:"2.7 Apakah Operator memahami target ritase tiap jam pada fleet tsb?"},
    {tipe:"DTS", uk:"UK2", soal:8, text:"2.8 Apakah Operator memahami jumlah passing untuk unit yang dioperasikan?"},

    //UK3
    {tipe:"DTS", uk:"UK3", soal:1, text:"3.1 Apakah Operator mengetahui dimensi unit?"},
    {tipe:"DTS", uk:"UK3", soal:2, text:"3.2 Apakah Operator mengetahui jarak blind spot unit?"},
    {tipe:"DTS", uk:"UK3", soal:3, text:"3.3 Apakah Operator mengetahui fungsi unit?"},
    {tipe:"DTS", uk:"UK3", soal:4, text:"3.4 Apakah Operator mengetahui 5 system engine?"},
    {tipe:"DTS", uk:"UK3", soal:5, text:"3.5 Apakah Operator mengetahui power train pada unit?"},
    {tipe:"DTS", uk:"UK3", soal:6, text:"3.6 Apakah Operator mengetahui kapasitas fuel unit yang dioperasikannya?"},

    //UK4
    {tipe:"DTS", uk:"UK4", soal:1, text:"4.1 Apakah Operator memahami fungsi instrumen panel?"},
    {tipe:"DTS", uk:"UK4", soal:2, text:"4.2 Apakah Operator memahami cara membaca instrumen panel? Sampling minimal 3"},
    {tipe:"DTS", uk:"UK4", soal:3, text:"4.3 Apakah Operator memahami warning category pada instrumen panel?"},
    {tipe:"DTS", uk:"UK4", soal:4, text:"4.4 Apakah Operator memahami tindak lanjut jika instrumen panel menyala? Sampling minimal 3"},
    {tipe:"DTS", uk:"UK4", soal:5, text:"4.5 Apakah Operator memahami nama control lever & pedal? Sampling minimal 3"},
    {tipe:"DTS", uk:"UK4", soal:6, text:"4.6 Apakah Operator memahami fungsi control lever & pedal? Sampling minimal 3"},

    //UK5
    {tipe:"DTS", uk:"UK5", soal:1, text:"5.1 Apakah Operator memahami tujuan P2H?"},
    {tipe:"DTS", uk:"UK5", soal:2, text:"5.2 Apakah Operator memahami 4 langkah P2H?"},
    {tipe:"DTS", uk:"UK5", soal:3, text:"5.3 Apakah Operator melakukan pemeriksaan keliling unit?"},
    {tipe:"DTS", uk:"UK5", soal:4, text:"5.4 Apakah Operator memahami komponen yang diperiksa saat keliling unit? Sampling minimal 3"},
    {tipe:"DTS", uk:"UK5", soal:5, text:"5.5 Apakah Operator melakukan pemeriksaan diatas unit sebelum engine hidup?"},
    {tipe:"DTS", uk:"UK5", soal:6, text:"5.6 Apakah Operator memahami komponen yang diperiksan saat diatas unit sebelum engine hidup? Sampling minimal 3"},
    {tipe:"DTS", uk:"UK5", soal:7, text:"5.7 Apakah Operator melakukan pemeriksaan diatas unit setelah engine hidup?"},
    {tipe:"DTS", uk:"UK5", soal:8, text:"5.8 Apakah Operator memahami komponen yang diperiksan saat diatas unit setelah engine hidup? Sampling minimal 3"},
    {tipe:"DTS", uk:"UK5", soal:9, text:"5.9 Apakah Operator melakukan pemeriksaan setelah operasi?"},
    {tipe:"DTS", uk:"UK5", soal:10, text:"5.10 Apakah Operator memahami komponen yang diperiksan setelah operasi? Sampling minimal 3"},
    {tipe:"DTS", uk:"UK5", soal:11, text:"5.11 Apakah Operator memahami kode bahaya untuk temuan P2H?"},
    {tipe:"DTS", uk:"UK5", soal:12, text:"5.12 Apakah Operator menuliskan temuan P2H pada kertas P2H?"},
    {tipe:"DTS", uk:"UK5", soal:13, text:"5.13 Apakah Operator memahami cara mengisi form P2H?"},

    //UK6
    {tipe:"DTS", uk:"UK6", soal:1, text:"6.1 Apakah Operator melakukan manuver sebelum loading searah jarum jam?"},
    {tipe:"DTS", uk:"UK6", soal:2, text:"6.2 Apakah Operator menempatkan lever transimis pada posisi P saat loading?"},
    {tipe:"DTS", uk:"UK6", soal:3, text:"6.3 Apakah Operator tepat menggunakan transmisi saat awal bergerak maju setelah loading?"},
    {tipe:"DTS", uk:"UK6", soal:4, text:"6.4 Apakah Operator menggunakan transmisi dan speed sesuai dengan kondisi jalan?"},
    {tipe:"DTS", uk:"UK6", soal:5, text:"6.5 Apakah Operator menggunakan Shift Limit & Power Economy Mode sesuai dengan kondisi jalan?"},
    {tipe:"DTS", uk:"UK6", soal:6, text:"6.6 Apakah Operator menggunakan brake sesuai dengan kondisi jalan?"},
    {tipe:"DTS", uk:"UK6", soal:7, text:"6.7 Apakah Operator menjaga jarak beriringan dengan unit lain ≥ 40 m?"},
    {tipe:"DTS", uk:"UK6", soal:8, text:"6.8 Apakah Operator mengambil haluan saat belok atau di tikungan dengan tepat?"},
    {tipe:"DTS", uk:"UK6", soal:9, text:"6.9 Apakah Operator terampil dalam mengemudi atau pengendalian steering wheel?"},
    {tipe:"DTS", uk:"UK6", soal:10, text:"6.10 Apakah Operator TIDAK melakukan neutral coasitng?"},
    {tipe:"DTS", uk:"UK6", soal:11, text:"6.11 Apakah Operator TIDAK melakukan abuse shifting?"},
    {tipe:"DTS", uk:"UK6", soal:12, text:"6.12 Apakah Operator TIDAK tidak melakukan hunting?"},
    {tipe:"DTS", uk:"UK6", soal:13, text:"6.13 Apakah Operator TIDAK melakukan gear select harmfull?"},
    {tipe:"DTS", uk:"UK6", soal:14, text:"6.14 Apakah Operator TIDAK melakukan overrunning?"},
    {tipe:"DTS", uk:"UK6", soal:15, text:"6.15Apakah Operator TIDAK melakukan melakukan manuver dengan gerakan patah (end stroke steering)?"},
    {tipe:"DTS", uk:"UK6", soal:16, text:"6.16 Apakah Operator melakukan manuver searah jarum jam sebelum dumping?"},
    {tipe:"DTS", uk:"UK6", soal:17, text:"6.17 Apakah Operator mengikuti arahan GL Disposal atau dump man untuk titik dumping?"},
    {tipe:"DTS", uk:"UK6", soal:18, text:"6.18 Apakah Operator menjaga jarak dumping dengan unit lain?"},
    {tipe:"DTS", uk:"UK6", soal:19, text:"6.19 Apakah Operator menggunakan parkirng brake saat dumping?"},
    {tipe:"DTS", uk:"UK6", soal:20, text:"6.20 Apakah Operator menggunakan rpm dumping yang tepat?"},
    {tipe:"DTS", uk:"UK6", soal:21, text:"6.21 Apakah Operator menurunkan vessel dengan metode yang tepat?"},
    {tipe:"DTS", uk:"UK6", soal:22, text:"6.22 Apakah setelah dumping Operator menurunkan vessel terlebih dahulu kemudian mengoperasikan unit?"},
    {tipe:"DTS", uk:"UK6", soal:23, text:"6.23 Apakah Operator parkir dalam posisi rata dan aman?"},
    {tipe:"DTS", uk:"UK6", soal:24, text:"6.24 Apakah Operator menempatakan lever transmisi pada posisi P saat parkir?"},
    {tipe:"DTS", uk:"UK6", soal:25, text:"6.25 Apakah Operator melakukan idle sebelum shut down engine?"},

  ],
  
  DTM: [
    //UK1
    {tipe:"DTM", uk:"UK1", soal:1, text:"1.1 Apakah Operator dalam kondisi sehat dan menggunakan APD Lengkap?"},
    {tipe:"DTM", uk:"UK1", soal:2, text:"1.2 Apakah Operator menggunakan sabuk pengaman?"},
    {tipe:"DTM", uk:"UK1", soal:3, text:"1.3 Apakah Operator melakukan aturan klakson?"},
    {tipe:"DTM", uk:"UK1", soal:4, text:"1.4 Apakah Operator mengaktifkan lampu unit?"},
    {tipe:"DTM", uk:"UK1", soal:5, text:"1.5 Apakah Operator mengetahui nama rambu? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK1", soal:6, text:"1.6 Apakah Operator mengimplementasikan aturan rambu-rambu?"},
    {tipe:"DTM", uk:"UK1", soal:7, text:"1.7 Apakah Operator mengendarai sesuai dengan rambu kecepatan?"},
    {tipe:"DTM", uk:"UK1", soal:8, text:"1.8 Apakah Operator memahami Emergency Response saat terjadi kebakaran pada unit yang dioperasikan?"},
    {tipe:"DTM", uk:"UK1", soal:9, text:"1.9 Apakah Operator memahami Emergency Response saat terjadi steering failure pada unit yang dioperasikan?"},
    {tipe:"DTM", uk:"UK1", soal:10, text:"1.10 Apakah Operator memahami Emergency Response saat terjadi brake failure pada unit yang dioperasikan?"},
    {tipe:"DTM", uk:"UK1", soal:11, text:"1.11 Apakah Operator memahami Emergency Response saat terjadi unit breakdown di jalan pada unit yang dioperasikan?"},
    {tipe:"DTM", uk:"UK1", soal:12, text:"1.12 Apakah Operator memahami Emergency Response pasca penyiraman/jalan licin pada unit yang dioperasikan?"},

    //UK2
    {tipe:"DTM", uk:"UK2", soal:1, text:"2.1 Apakah Operator melaporkan KTA dan/atau TTA kepada Pengawas?"},
    {tipe:"DTM", uk:"UK2", soal:2, text:"2.2 Apakah Operator mengetahui metode pelaporan insiden?"},
    {tipe:"DTM", uk:"UK2", soal:3, text:"2.3 Apakah Operator dapat melakukan pelaporan KTA dan/atau TTA dengan aplikasi Sinergi?"},
    {tipe:"DTM", uk:"UK2", soal:4, text:"2.4 Apakah Operator melaporkan malfungsi kondisi unit kepada Pengawas/OCR?"},
    {tipe:"DTM", uk:"UK2", soal:5, text:"2.5 Apakah Operator memahami dan malakukan aturan lampu sein?"},
    ...
    {tipe:"DTM", uk:"UK3", soal:2, text:"3.2 Apakah Operator mengetahui jarak blind spot unit?"},
    {tipe:"DTM", uk:"UK3", soal:3, text:"3.3 Apakah Operator mengetahui fungsi unit?"},
    {tipe:"DTM", uk:"UK3", soal:4, text:"3.4 Apakah Operator mengetahui 5 system engine?"},
    {tipe:"DTM", uk:"UK3", soal:5, text:"3.5 Apakah Operator mengetahui power train pada unit?"},
    {tipe:"DTM", uk:"UK3", soal:6, text:"3.6 Apakah Operator mengetahui kapasitas fuel unit yang dioperasikannya?"},

    //UK4
    {tipe:"DTM", uk:"UK4", soal:1, text:"4.1 Apakah Operator memahami fungsi instrumen panel?"},
    {tipe:"DTM", uk:"UK4", soal:2, text:"4.2 Apakah Operator memahami cara membaca instrumen panel? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK4", soal:3, text:"4.3 Apakah Operator memahami warning category pada instrumen panel?"},
    {tipe:"DTM", uk:"UK4", soal:4, text:"4.4 Apakah Operator memahami tindak lanjut jika instrumen panel menyala? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK4", soal:5, text:"4.5 Apakah Operator memahami nama control lever & pedal? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK4", soal:6, text:"4.6 Apakah Operator memahami fungsi control lever & pedal? Sampling minimal 3"},

    //UK5
    {tipe:"DTM", uk:"UK5", soal:1, text:"5.1 Apakah Operator memahami tujuan P2H?"},
    {tipe:"DTM", uk:"UK5", soal:2, text:"5.2 Apakah Operator memahami 4 langkah P2H?"},
    {tipe:"DTM", uk:"UK5", soal:3, text:"5.3 Apakah Operator melakukan pemeriksaan keliling unit?"},
    {tipe:"DTM", uk:"UK5", soal:4, text:"5.4 Apakah Operator memahami komponen yang diperiksa saat keliling unit? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK5", soal:5, text:"5.5 Apakah Operator melakukan pemeriksaan diatas unit sebelum engine hidup?"},
    {tipe:"DTM", uk:"UK5", soal:6, text:"5.6 Apakah Operator memahami komponen yang diperiksan saat diatas unit sebelum engine hidup? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK5", soal:7, text:"5.7 Apakah Operator melakukan pemeriksaan diatas unit setelah engine hidup?"},
    {tipe:"DTM", uk:"UK5", soal:8, text:"5.8 Apakah Operator memahami komponen yang diperiksan saat diatas unit setelah engine hidup? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK5", soal:9, text:"5.9 Apakah Operator melakukan pemeriksaan setelah operasi?"},
    {tipe:"DTM", uk:"UK5", soal:10, text:"5.10 Apakah Operator memahami komponen yang diperiksan setelah operasi? Sampling minimal 3"},
    {tipe:"DTM", uk:"UK5", soal:11, text:"5.11 Apakah Operator memahami kode bahaya untuk temuan P2H?"},
    {tipe:"DTM", uk:"UK5", soal:12, text:"5.12 Apakah Operator menuliskan temuan P2H pada kertas P2H?"},
    {tipe:"DTM", uk:"UK5", soal:13, text:"5.13 Apakah Operator memahami cara mengisi form P2H?"},
